...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      "100+ engineered features, nested CV over 6 classifier families, LightGBM AUC 0.8214 — 8th of 35 teams in the UMD Data Mining course competition.",
    description:
    ...
    attribution: {
      ...
      role: "Team member — feature engineering & LightGBM tuning (pending confirmation)",
      teamSize: 3,
  ...
  },
  {
    ...
    attribution: {
      ...
      role: "Team member — role pending confirmation",
      teamSize: 7,
    },
  },
  {
    ...
    summary:
      "Random Forest classifier on 30,000 Spotify tracks (1957–2020). Precision 0.83 · recall 0.59 · 3.4× lift in top decile — with the finding that production traits beat mood features.",
    description:
